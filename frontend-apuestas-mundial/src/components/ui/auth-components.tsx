...
const TechOrbitDisplay = memo(function TechOrbitDisplay({
  ...
  return (
    <section className='relative flex h-full w-full flex-col items-center justify-center overflow-hidden rounded-lg'>
      <div className="flex flex-col items-center justify-center z-10 pointer-events-none gap-2">
        {centerImage}
        <span className='whitespace-pre-wrap bg-gradient-to-b from-black to-gray-400 bg-clip-text text-center text-4xl md:text-5xl font-bold leading-none text-transparent dark:from-white dark:to-slate-900/10'>
          {text}
        </span>
      </div>
