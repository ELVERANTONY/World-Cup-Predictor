...
router.get('/match/:matchId', authenticate, predictionController.getByMatch.bind(predictionController));
router.get('/room/:roomId', authenticate, predictionController.getByRoom.bind(predictionController));
router.get('/simulate', authenticate, authorize('ADMIN'), predictionController.simulateScore.bind(predictionController));
